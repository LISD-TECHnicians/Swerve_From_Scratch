...
public final class Constants {
  public final class Drive_Constants {
    ...
    public static final boolean Swerve_1_Drive_Motor_Invert = true;
    ...
    public static final boolean Swerve_2_Drive_Motor_Invert = true;
    ...
    public static final boolean Swerve_3_Drive_Motor_Invert = true;
